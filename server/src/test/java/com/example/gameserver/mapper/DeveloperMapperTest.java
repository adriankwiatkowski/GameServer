...
class DeveloperMapperTest{
    @Autowired
    private DeveloperMapper developerMaper;
    @Test
    public void givenDeveloper_whenMapToDeveloperDto_thenOk() {
        Developer developer = new Developer();
        developer.setId(1L);
        developer.setName("Developer");
        DeveloperDto developerDto = developerMaper.from(developer);
    ...
    public void givenDeveloperDto_whenMapToDeveloper_thenOk() {
        ...
        Developer developer = developerMaper.toDeveloper(developerDto);
